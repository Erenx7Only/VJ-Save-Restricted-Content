...
API_ID = int(os.environ.get("API_ID", "32167370"))

# Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "26f4b12511b3d531078f3e6739b60004")

# Your Owner / Admin Id For Broadcast 
ADMINS = int(os.environ.get("ADMINS", "8327904812"))
...
DB_URI = os.environ.get("DB_URI", "mongodb://mongo:PWbFBjFROhzNZWbtRPVSRgymhTBSEEpS@acela.proxy.rlwy.net:31235") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
